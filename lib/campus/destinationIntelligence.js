const {
  CAMPUS_UTILITIES,
  UTILITY_CATEGORIES
} = require("../../data/campus/utilities.js");
const { CAMPUS_ROOMS } = require("../../data/campus/rooms.js");
const { getIndoorAvailabilityForBuilding } = require("./indoor/availability.js");
...
function createDestinationIntelligence(navigationData) {
  ...
  const indoorDestination = building
    ? getIndoorAvailabilityForBuilding(building.id, selectedEntrance?.id || "")
    : null;
  ...
  return {
    ...
    indoorDirections,
    indoorNavigation: indoorDestination
      ? {
          buildingId: indoorDestination.indoorBuilding?.buildingId || building?.id || "",
          available: indoorDestination.available,
          dataAvailable: indoorDestination.dataAvailable,
          transferNodeId: indoorDestination.transferNodeId,
          message: indoorDestination.message
        }
      : {
